...
set C_modelArgList {
	{ pos_list int 11 regular {array 61 { 0 3 } 0 1 }  }
	{ sign_list int 2 regular {array 61 { 0 3 } 0 1 }  }
	{ c_bin int 8 regular {array 32 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "pos_list", "interface" : "memory", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ pos_list_d0 sc_out sc_lv 11 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pos_list_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "pos_list", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	pos_list { ap_memory {  { pos_list_address0 mem_address 1 6 }  { pos_list_ce0 mem_ce 1 1 }  { pos_list_we0 mem_we 1 1 }  { pos_list_d0 mem_din 1 11 } } }
