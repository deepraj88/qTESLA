...
set id 46
set name crypto_sign_mac_muladd_9ns_8ns_5s_17_1_1
...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {9 0 +} i1 {8 0 +} m {17 0 +} i2 {5 1 +} p {17 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a \
    op interface \
    ports { a_address0 { O 11 vector } a_ce0 { O 1 bit } a_we0 { O 1 bit } a_d0 { O 25 vector } } \
} "
} else {
