...
set C_modelArgList {
	{ a int 32 regular {array 4823 { 2 2 } 1 1 }  }
	{ g int 32 regular {array 689 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ a_address1 sc_out sc_lv 13 signal 0 } 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 13 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 }  { a_q0 mem_dout 0 32 }  { a_address1 MemPortADDR2 1 13 }  { a_ce1 MemPortCE2 1 1 }  { a_we1 MemPortWE2 1 1 }  { a_d1 MemPortDIN2 1 32 }  { a_q1 MemPortDOUT2 0 32 } } }
