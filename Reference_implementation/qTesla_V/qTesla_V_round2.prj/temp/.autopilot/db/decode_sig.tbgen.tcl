...
set portList { 
	...
	{ z_address0 sc_out sc_lv 11 signal 1 } 
	{ z_ce0 sc_out sc_logic 1 signal 1 } 
	{ z_we0 sc_out sc_logic 1 signal 1 } 
	{ z_d0 sc_out sc_lv 23 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "z_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "z", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	z { ap_memory {  { z_address0 mem_address 1 11 }  { z_ce0 mem_ce 1 1 }  { z_we0 mem_we 1 1 }  { z_d0 mem_din 1 23 } } }
