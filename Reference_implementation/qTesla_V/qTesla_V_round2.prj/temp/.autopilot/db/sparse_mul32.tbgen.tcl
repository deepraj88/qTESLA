...
set C_modelArgList {
	...
	{ pk int 25 regular {array 2048 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "prod", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "pk", "interface" : "memory", "bitwidth" : 25, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pk_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "pk", "role": "q0" }} , 
 	...
 	{ "name": "pk_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "pk", "role": "q1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "501884", "Max" : "501884"}
	, {"Name" : "Interval", "Min" : "501884", "Max" : "501884"}
]}
...
set Spec2ImplPortList { 
	...
	pk { ap_memory {  { pk_address0 mem_address 1 11 }  { pk_ce0 mem_ce 1 1 }  { pk_q0 mem_dout 0 25 }  { pk_address1 MemPortADDR2 1 11 }  { pk_ce1 MemPortCE2 1 1 }  { pk_q1 MemPortDOUT2 0 25 } } }
