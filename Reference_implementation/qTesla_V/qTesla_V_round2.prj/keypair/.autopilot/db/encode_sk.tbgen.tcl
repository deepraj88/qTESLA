...
set Spec2ImplPortList { 
	...
	s { ap_memory {  { s_address0 mem_address 1 11 }  { s_ce0 mem_ce 1 1 }  { s_q0 mem_dout 0 16 }  { s_address1 MemPortADDR2 1 11 }  { s_ce1 MemPortCE2 1 1 }  { s_q1 MemPortDOUT2 0 16 } } }
	e { ap_memory {  { e_address0 mem_address 1 11 }  { e_ce0 mem_ce 1 1 }  { e_q0 mem_dout 0 16 }  { e_address1 MemPortADDR2 1 11 }  { e_ce1 MemPortCE2 1 1 }  { e_q1 MemPortDOUT2 0 16 } } }
