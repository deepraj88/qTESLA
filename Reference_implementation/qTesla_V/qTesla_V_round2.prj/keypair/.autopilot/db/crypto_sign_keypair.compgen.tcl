...
set ID 83
set hasByteEnable 0
set MemName crypto_sign_keypapcA
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 128
...
set ID 85
set hasByteEnable 0
set MemName crypto_sign_keypasc4
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 25
set AddrRange 2048
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 13 vector } pk_ce0 { O 1 bit } pk_we0 { O 1 bit } pk_d0 { O 8 vector } pk_address1 { O 13 vector } pk_ce1 { O 1 bit } pk_we1 { O 1 bit } pk_d1 { O 8 vector } } \
} "
} else {
