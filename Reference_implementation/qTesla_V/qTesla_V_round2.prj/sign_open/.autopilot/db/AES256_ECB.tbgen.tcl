...
set Spec2ImplPortList { 
	...
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 6 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 8 }  { buffer_r_address1 mem_address 1 6 }  { buffer_r_ce1 mem_ce 1 1 }  { buffer_r_we1 mem_we 1 1 }  { buffer_r_d1 mem_din 1 8 } } }
