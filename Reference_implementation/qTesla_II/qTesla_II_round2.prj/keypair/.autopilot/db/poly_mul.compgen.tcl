...
set ID 78
set hasByteEnable 0
set MemName poly_mul_psi_phi_tab
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 768
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y \
    op interface \
    ports { y_address0 { O 10 vector } y_ce0 { O 1 bit } y_q0 { I 16 vector } } \
} "
} else {
