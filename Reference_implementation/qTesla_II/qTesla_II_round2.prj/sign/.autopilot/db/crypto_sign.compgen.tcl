...
set ID 109
set hasByteEnable 0
set MemName crypto_sign_rev_tab
...
set ID 110
set hasByteEnable 0
set MemName crypto_sign_twiddle
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 128
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 11 vector } sk_ce0 { O 1 bit } sk_q0 { I 8 vector } } \
} "
} else {
