...
set C_modelArgList {
	{ result int 32 regular {array 768 { 2 2 } 1 1 }  }
	{ x int 32 regular {array 768 { 1 3 } 1 1 }  }
	{ y int 32 regular {array 768 { 1 3 } 1 1 }  }
	{ rev_tab int 64 regular {array 128 { 2 3 } 1 1 } {global 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "result", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "rev_tab", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE", "extern" : 0} , 
...
set portList { 
	...
	{ rev_tab_we0 sc_out sc_logic 1 signal 3 } 
	{ rev_tab_d0 sc_out sc_lv 64 signal 3 } 
	{ rev_tab_q0 sc_in sc_lv 64 signal 3 } 
	{ twiddle_address0 sc_out sc_lv 7 signal 4 } 
	{ twiddle_ce0 sc_out sc_logic 1 signal 4 } 
	{ twiddle_we0 sc_out sc_logic 1 signal 4 } 
	{ twiddle_d0 sc_out sc_lv 32 signal 4 } 
	{ twiddle_q0 sc_in sc_lv 32 signal 4 } 
	{ t_tab_address0 sc_out sc_lv 4 signal 5 } 
	{ t_tab_ce0 sc_out sc_logic 1 signal 5 } 
	{ t_tab_we0 sc_out sc_logic 1 signal 5 } 
	{ t_tab_d0 sc_out sc_lv 32 signal 5 } 
	{ t_tab_q0 sc_in sc_lv 32 signal 5 } 
	{ t_tab_address1 sc_out sc_lv 4 signal 5 } 
	{ t_tab_ce1 sc_out sc_logic 1 signal 5 } 
	{ t_tab_q1 sc_in sc_lv 32 signal 5 } 
	{ psi_phi_tab_address0 sc_out sc_lv 10 signal 6 } 
	{ psi_phi_tab_ce0 sc_out sc_logic 1 signal 6 } 
	{ psi_phi_tab_we0 sc_out sc_logic 1 signal 6 } 
	{ psi_phi_tab_d0 sc_out sc_lv 32 signal 6 } 
	{ psi_phi_tab_q0 sc_in sc_lv 32 signal 6 } 
	{ iph_ips_tab_address0 sc_out sc_lv 10 signal 7 } 
	{ iph_ips_tab_ce0 sc_out sc_logic 1 signal 7 } 
	{ iph_ips_tab_we0 sc_out sc_logic 1 signal 7 } 
	{ iph_ips_tab_d0 sc_out sc_lv 32 signal 7 } 
	{ iph_ips_tab_q0 sc_in sc_lv 32 signal 7 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "8", "14"],
		"CDFG" : "poly_mul",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "result", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_invNTT_fu_171", "Port" : "a"}]},
			{"Name" : "x", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "y", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "rev_tab", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_NTT_fu_185", "Port" : "rev_tab"},
					{"ID" : "2", "SubInstance" : "grp_invNTT_fu_171", "Port" : "rev_tab"},
					{"ID" : "14", "SubInstance" : "grp_nttInit_fu_198", "Port" : "rev_tab"}]},
			{"Name" : "twiddle", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_NTT_fu_185", "Port" : "twiddle"},
					{"ID" : "2", "SubInstance" : "grp_invNTT_fu_171", "Port" : "twiddle"},
					{"ID" : "14", "SubInstance" : "grp_nttInit_fu_198", "Port" : "twiddle"}]},
			{"Name" : "t_tab", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_NTT_fu_185", "Port" : "t_tab"},
					{"ID" : "2", "SubInstance" : "grp_invNTT_fu_171", "Port" : "t_tab"},
					{"ID" : "14", "SubInstance" : "grp_nttInit_fu_198", "Port" : "t_tab"}]},
			{"Name" : "psi_phi_tab", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_NTT_fu_185", "Port" : "psi_phi_tab"},
					{"ID" : "14", "SubInstance" : "grp_nttInit_fu_198", "Port" : "psi_phi_tab"}]},
			{"Name" : "iph_ips_tab", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_invNTT_fu_171", "Port" : "iph_ips_tab"},
					{"ID" : "14", "SubInstance" : "grp_nttInit_fu_198", "Port" : "iph_ips_tab"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.y_ntt_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171", "Parent" : "0", "Child" : ["3", "4", "5", "6", "7"],
		"CDFG" : "invNTT",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171.aA_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171.grp_MODQ_fu_437", "Parent" : "2",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171.grp_MODQ_fu_443", "Parent" : "2",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171.grp_MODQ_fu_449", "Parent" : "2",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_invNTT_fu_171.grp_MODQ_fu_454", "Parent" : "2",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185", "Parent" : "0", "Child" : ["9", "10", "11", "12", "13"],
		"CDFG" : "NTT",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "twiddle", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "t_tab", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185.Aa_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185.grp_MODQ_fu_379", "Parent" : "8",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185.grp_MODQ_fu_385", "Parent" : "8",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185.grp_MODQ_fu_391", "Parent" : "8",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_NTT_fu_185.grp_MODQ_fu_396", "Parent" : "8",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_nttInit_fu_198", "Parent" : "0", "Child" : ["15", "16", "17"],
		"CDFG" : "nttInit",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "psi_phi_tab", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "iph_ips_tab", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_nttInit_fu_198.t_inv_tab_U", "Parent" : "14"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_nttInit_fu_198.grp_MODQ_fu_499", "Parent" : "14",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "v", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_nttInit_fu_198.grp_MODQ_fu_507", "Parent" : "14",
		"CDFG" : "MODQ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	result { ap_memory {  { result_address0 mem_address 1 10 }  { result_ce0 mem_ce 1 1 }  { result_we0 mem_we 1 1 }  { result_d0 mem_din 1 32 }  { result_q0 mem_dout 0 32 }  { result_address1 MemPortADDR2 1 10 }  { result_ce1 MemPortCE2 1 1 }  { result_we1 MemPortWE2 1 1 }  { result_d1 MemPortDIN2 1 32 }  { result_q1 MemPortDOUT2 0 32 } } }
	...
	rev_tab { ap_memory {  { rev_tab_address0 mem_address 1 7 }  { rev_tab_ce0 mem_ce 1 1 }  { rev_tab_we0 mem_we 1 1 }  { rev_tab_d0 mem_din 1 64 }  { rev_tab_q0 mem_dout 0 64 } } }
