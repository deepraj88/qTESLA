...
set C_modelArgList {
	...
	{ s int 16 regular {array 512 { 1 1 } 1 1 }  }
	{ e int 16 regular {array 512 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ sk_address1 sc_out sc_lv 11 signal 0 } 
...
set Spec2ImplPortList { 
	...
	s { ap_memory {  { s_address0 mem_address 1 9 }  { s_ce0 mem_ce 1 1 }  { s_q0 mem_dout 0 16 }  { s_address1 MemPortADDR2 1 9 }  { s_ce1 MemPortCE2 1 1 }  { s_q1 MemPortDOUT2 0 16 } } }
	e { ap_memory {  { e_address0 mem_address 1 9 }  { e_ce0 mem_ce 1 1 }  { e_q0 mem_dout 0 16 }  { e_address1 MemPortADDR2 1 9 }  { e_ce1 MemPortCE2 1 1 }  { e_q1 MemPortDOUT2 0 16 } } }
