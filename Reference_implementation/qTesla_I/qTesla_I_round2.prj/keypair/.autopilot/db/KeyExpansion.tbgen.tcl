...
set Spec2ImplPortList { 
	RoundKey { ap_memory {  { RoundKey_address0 mem_address 1 8 }  { RoundKey_ce0 mem_ce 1 1 }  { RoundKey_we0 mem_we 1 1 }  { RoundKey_d0 mem_din 1 8 }  { RoundKey_q0 mem_dout 0 8 }  { RoundKey_address1 MemPortADDR2 1 8 }  { RoundKey_ce1 MemPortCE2 1 1 }  { RoundKey_we1 MemPortWE2 1 1 }  { RoundKey_d1 MemPortDIN2 1 8 }  { RoundKey_q1 MemPortDOUT2 0 8 } } }
