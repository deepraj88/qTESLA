...
set C_modelArgList {
	...
	{ t int 32 regular {array 512 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ t_address0 sc_out sc_lv 9 signal 1 } 
	{ t_ce0 sc_out sc_logic 1 signal 1 } 
	{ t_q0 sc_in sc_lv 32 signal 1 } 
	{ t_address1 sc_out sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "t", "role": "address0" }} , 
 	...
 	{ "name": "t_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "t", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	t { ap_memory {  { t_address0 mem_address 1 9 }  { t_ce0 mem_ce 1 1 }  { t_q0 mem_dout 0 32 }  { t_address1 MemPortADDR2 1 9 }  { t_ce1 MemPortCE2 1 1 }  { t_q1 MemPortDOUT2 0 32 } } }
