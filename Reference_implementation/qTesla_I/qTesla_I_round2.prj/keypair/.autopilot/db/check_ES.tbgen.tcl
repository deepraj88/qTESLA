...
set C_modelArgList {
	{ p int 16 regular {array 512 { 1 3 } 1 1 }  }
}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "30036", "Max" : "31776"}
	, {"Name" : "Interval", "Min" : "30036", "Max" : "31776"}
]}
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 9 }  { p_ce0 mem_ce 1 1 }  { p_q0 mem_dout 0 16 } } }
}
