...
set ID 102
set hasByteEnable 0
set MemName crypto_sign_randovdy
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 128
...
set ID 104
set hasByteEnable 0
set MemName crypto_sign_pos_lwdI
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 9
set AddrRange 30
...
set ID 105
set hasByteEnable 0
set MemName crypto_sign_sign_xdS
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 2
set AddrRange 30
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sm \
    op interface \
    ports { sm_address0 { O 13 vector } sm_ce0 { O 1 bit } sm_we0 { O 1 bit } sm_d0 { O 8 vector } sm_address1 { O 13 vector } sm_ce1 { O 1 bit } sm_we1 { O 1 bit } sm_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 11 vector } sk_ce0 { O 1 bit } sk_q0 { I 8 vector } sk_address1 { O 11 vector } sk_ce1 { O 1 bit } sk_q1 { I 8 vector } } \
} "
} else {
