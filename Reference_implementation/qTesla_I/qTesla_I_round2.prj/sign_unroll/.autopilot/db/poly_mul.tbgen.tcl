...
set C_modelArgList {
	{ result int 32 regular {array 512 { 2 1 } 1 1 }  }
	{ x int 23 regular {array 512 { 1 3 } 1 1 }  }
	{ y int 22 regular {array 512 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "result", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "x", "interface" : "memory", "bitwidth" : 23, "direction" : "READONLY"} , 
 	{ "Name" : "y", "interface" : "memory", "bitwidth" : 22, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ result_address0 sc_out sc_lv 9 signal 0 } 
	...
	{ result_address1 sc_out sc_lv 9 signal 0 } 
	{ result_ce1 sc_out sc_logic 1 signal 0 } 
	{ result_q1 sc_in sc_lv 32 signal 0 } 
	{ x_address0 sc_out sc_lv 9 signal 1 } 
	{ x_ce0 sc_out sc_logic 1 signal 1 } 
	{ x_q0 sc_in sc_lv 23 signal 1 } 
	{ y_address0 sc_out sc_lv 9 signal 2 } 
	{ y_ce0 sc_out sc_logic 1 signal 2 } 
	{ y_q0 sc_in sc_lv 22 signal 2 } 
	{ zeta_address0 sc_out sc_lv 9 signal 3 } 
	{ zeta_ce0 sc_out sc_logic 1 signal 3 } 
	{ zeta_q0 sc_in sc_lv 32 signal 3 } 
	{ zetainv_address0 sc_out sc_lv 9 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "result", "role": "address1" }} , 
 	...
 	{ "name": "x_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "x", "role": "q0" }} , 
 	...
 	{ "name": "y_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "y", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_mac_mpcA_U69", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	result { ap_memory {  { result_address0 mem_address 1 9 }  { result_ce0 mem_ce 1 1 }  { result_we0 mem_we 1 1 }  { result_d0 mem_din 1 32 }  { result_q0 mem_dout 0 32 }  { result_address1 mem_address 1 9 }  { result_ce1 mem_ce 1 1 }  { result_q1 mem_dout 0 32 } } }
	x { ap_memory {  { x_address0 mem_address 1 9 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 23 } } }
	y { ap_memory {  { y_address0 mem_address 1 9 }  { y_ce0 mem_ce 1 1 }  { y_q0 mem_dout 0 22 } } }
