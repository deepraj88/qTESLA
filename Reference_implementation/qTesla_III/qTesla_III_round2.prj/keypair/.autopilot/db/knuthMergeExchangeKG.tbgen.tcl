set moduleName knuthMergeExchangeKG
...
set C_modelName {knuthMergeExchangeKG}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 32 regular {array 2580 { 2 2 } 1 1 }  }
	{ g int 32 regular {array 645 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ g_address1 sc_out sc_lv 10 signal 1 } 
	{ g_ce1 sc_out sc_logic 1 signal 1 } 
	{ g_we1 sc_out sc_logic 1 signal 1 } 
	{ g_d1 sc_out sc_lv 32 signal 1 } 
	{ g_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "g_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "g", "role": "address1" }} , 
 	{ "name": "g_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "g", "role": "ce1" }} , 
 	{ "name": "g_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "g", "role": "we1" }} , 
 	{ "name": "g_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "g", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 12 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 }  { a_q0 mem_dout 0 32 }  { a_address1 mem_address 1 12 }  { a_ce1 mem_ce 1 1 }  { a_we1 mem_we 1 1 }  { a_d1 mem_din 1 32 }  { a_q1 mem_dout 0 32 } } }
	g { ap_memory {  { g_address0 mem_address 1 10 }  { g_ce0 mem_ce 1 1 }  { g_we0 mem_we 1 1 }  { g_d0 mem_din 1 32 }  { g_q0 mem_dout 0 32 }  { g_address1 mem_address 1 10 }  { g_ce1 mem_ce 1 1 }  { g_we1 mem_we 1 1 }  { g_d1 mem_din 1 32 }  { g_q1 mem_dout 0 32 } } }
}
set moduleName knuthMergeExchangeKG
set isTaskLevelControl 1
set isCombinational 0
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 12 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 }  { a_q0 mem_dout 0 32 }  { a_address1 MemPortADDR2 1 12 }  { a_ce1 MemPortCE2 1 1 }  { a_we1 MemPortWE2 1 1 }  { a_d1 MemPortDIN2 1 32 }  { a_q1 MemPortDOUT2 0 32 } } }
	g { ap_memory {  { g_address0 mem_address 1 10 }  { g_ce0 mem_ce 1 1 }  { g_we0 mem_we 1 1 }  { g_d0 mem_din 1 32 }  { g_q0 mem_dout 0 32 }  { g_address1 MemPortADDR2 1 10 }  { g_ce1 MemPortCE2 1 1 }  { g_we1 MemPortWE2 1 1 }  { g_d1 MemPortDIN2 1 32 }  { g_q1 MemPortDOUT2 0 32 } } }
}
set moduleName knuthMergeExchangeKG
set isTaskLevelControl 1
set isCombinational 0
