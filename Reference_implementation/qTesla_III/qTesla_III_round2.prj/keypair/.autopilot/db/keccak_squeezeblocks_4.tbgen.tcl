...
set C_modelArgList {
	{ h int 8 regular {array 6384 { 0 3 } 0 1 }  }
	{ nblocks int 6 regular  }
	{ s int 64 regular {array 25 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "h", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "nblocks", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "h_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "h", "role": "address0" }} , 
 	...
 	{ "name": "nblocks", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "nblocks", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "285", "Max" : "10793"}
	, {"Name" : "Interval", "Min" : "285", "Max" : "10793"}
]}
...
set Spec2ImplPortList { 
	h { ap_memory {  { h_address0 mem_address 1 13 }  { h_ce0 mem_ce 1 1 }  { h_we0 mem_we 1 1 }  { h_d0 mem_din 1 8 } } }
	nblocks { ap_none {  { nblocks in_data 0 6 } } }
