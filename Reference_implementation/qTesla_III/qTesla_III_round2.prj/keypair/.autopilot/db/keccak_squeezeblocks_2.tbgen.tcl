...
set C_modelArgList {
	{ h int 8 regular {array 10320 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ h_address0 sc_out sc_lv 14 signal 0 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "14401", "Max" : "14401"}
	, {"Name" : "Interval", "Min" : "14401", "Max" : "14401"}
]}
...
set Spec2ImplPortList { 
	h { ap_memory {  { h_address0 mem_address 1 14 }  { h_ce0 mem_ce 1 1 }  { h_we0 mem_we 1 1 }  { h_d0 mem_din 1 8 } } }
