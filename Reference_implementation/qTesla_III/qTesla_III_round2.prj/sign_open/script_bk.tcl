...
############################################################
open_project qTesla_III_round2.prj
...
config_interface -clock_enable=0 -expose_global -m_axi_offset off -register_io off
#source "./qTesla_III_round2.prj/sign_open/directives_bk.tcl"
#csim_design
csynth_design
cosim_design
