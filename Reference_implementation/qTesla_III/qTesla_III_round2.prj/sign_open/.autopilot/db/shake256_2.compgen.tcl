...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 12 vector } input_r_ce0 { O 1 bit } input_r_q0 { I 8 vector } } \
} "
} else {
