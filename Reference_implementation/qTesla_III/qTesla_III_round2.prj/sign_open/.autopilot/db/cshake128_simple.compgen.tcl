...
set id 17
set name crypto_sign_open_urem_13ns_9ns_13_17_seq_1
...
set id 18
set name crypto_sign_open_mul_mul_15ns_13ns_28_1_1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {15 0 +} i1 {13 0 +} p {28 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 13 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_r \
    op interface \
    ports { in_r_address0 { O 5 vector } in_r_ce0 { O 1 bit } in_r_q0 { I 8 vector } } \
} "
} else {
