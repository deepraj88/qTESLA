...
set C_modelArgList {
	...
	{ s int 9 regular {array 1024 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_mac_mmb6_U110", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_mac_mncg_U111", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	s { ap_memory {  { s_address0 mem_address 1 10 }  { s_ce0 mem_ce 1 1 }  { s_q0 mem_dout 0 9 }  { s_address1 mem_address 1 10 }  { s_ce1 mem_ce 1 1 }  { s_q1 mem_dout 0 9 } } }
