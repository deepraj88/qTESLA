...
set C_modelArgList {
	...
	{ s int 9 regular {array 1024 { 0 0 } 0 1 }  }
	{ e int 9 regular {array 1024 { 0 0 } 0 1 }  }
...
set Spec2ImplPortList { 
	...
	s { ap_memory {  { s_address0 mem_address 1 10 }  { s_ce0 mem_ce 1 1 }  { s_we0 mem_we 1 1 }  { s_d0 mem_din 1 9 }  { s_address1 mem_address 1 10 }  { s_ce1 mem_ce 1 1 }  { s_we1 mem_we 1 1 }  { s_d1 mem_din 1 9 } } }
	e { ap_memory {  { e_address0 mem_address 1 10 }  { e_ce0 mem_ce 1 1 }  { e_we0 mem_we 1 1 }  { e_d0 mem_din 1 9 }  { e_address1 mem_address 1 10 }  { e_ce1 mem_ce 1 1 }  { e_we1 mem_we 1 1 }  { e_d1 mem_din 1 9 } } }
